defmodule Gits.HumanizeTime do
  @moduledoc """
  ...
  defp print_hours(1), do: "1 hour"
  defp print_hours(duration), do: "#{duration} hours"

  @spec print_minutes(integer()) :: String.t()
  defp print_minutes(0), do: ""
  defp print_minutes(1), do: "1 minute"
  defp print_minutes(duration), do: "#{duration} minutes"

  @spec print_seconds(integer()) :: String.t()
  defp print_seconds(0), do: ""
  defp print_seconds(1), do: "1 second"
  defp print_seconds(duration), do: "#{duration} seconds"
