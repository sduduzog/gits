defmodule GitsWeb.HostLive.EventComponents do
  ...
  def settings_form(%{current: :settings_time_and_place} = assigns) do
    ~H"""
  ...
  def settings_form(%{current: :settings_summary} = assigns) do
    ~H"""
